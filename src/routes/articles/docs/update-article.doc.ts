/**
 * @api {PUT} /articles/:id PUT - Update Article
 * @apiVersion 1.0.0
 * @apiName PutArticle
 * @apiSampleRequest off
 * @apiGroup Articles
 * @apiDescription  Updates an article by id
 ...
 *  <li><code>Please provide a title</code></li>
 *  <li><code>Please provide the content</code></li>
 * </ul>
