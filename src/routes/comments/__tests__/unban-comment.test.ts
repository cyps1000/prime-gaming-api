...
const config: TestConfig = {
  url: "/v1/comments/60b4fa10ded55343745e29d7/unban",
  method: "put",
...
it("returns 404 if trying to unban a comment that doesn't exist", async () => {
...
it("returns 200 when the request is successful", async () => {
  ...
  expect(responseComment.banned).toBe(false);
